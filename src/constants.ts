...
- عند عرض الوسائط: ممنوع تماماً استخدام أداة "get_media_content" إلا إذا طلب المستخدم صراحةً رؤية صور أو فيديوهات (زي "وريني صور"، "عايز أشوف فيديو"، "فرجني على شكل القاعة"). لا تعرض وسائط من تلقاء نفسك. استخدم كلمات بحث دقيقة جداً ومحددة من كلام المستخدم.
